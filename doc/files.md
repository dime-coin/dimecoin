...
* dimecoin.conf: contains configuration settings for dimecoind or dimecoin-qt
* dimecoind.pid: stores the process id of dimecoind while running
...
* debug.log: contains debug information and general logging generated by dimecoind or dimecoin-qt

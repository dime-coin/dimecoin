# Support for Output Descriptors in Dimecoin Core

Since Dimecoin Core 2.0.0.0, there is support for Output Descriptors in the
...
existing Dimecoin Core wallets, a convenience function `combo` is

The following is a list of assets used in the dimecoin source and their proper attribution.
...
* License: MIT
* Site: [https://dimecointalk.org/index.php?topic=15276.0](https://dimecointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original dimecoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/dimecoin.icns, src/qt/res/src/dimecoin.svg,
	src/qt/res/src/dimecoin.ico, src/qt/res/src/dimecoin.png,
	src/qt/res/src/dimecoin_testnet.png, docs/dimecoin_logo_doxygen.png,

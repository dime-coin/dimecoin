 ...
 * between dimecoind, and dimecoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/dime-coin>";
    const std::string URL_WEBSITE = "<https://www.dimecoinnetwork.com>";
...
bool AppInitMain()
{
    ...
    // ********************************************************* Step 11c: update block tip in Dimecoin modules

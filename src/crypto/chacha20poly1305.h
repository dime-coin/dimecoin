...
public:
    ...
    AEADChaCha20Poly1305(Span<const unsigned char> key) noexcept;
     ...
     */
    void Encrypt(Span<const unsigned char> plain, Span<const unsigned char> aad, Nonce96 nonce, Span<unsigned char> cipher) noexcept
    {
     ...
     */
    void Encrypt(Span<const unsigned char> plain1, Span<const unsigned char> plain2, Span<const unsigned char> aad, Nonce96 nonce, Span<unsigned char> cipher) noexcept;

    /** Decrypt a message with a specified 96-bit nonce and aad. Returns true if valid.
     *
     * Requires cipher.size() = plain.size() + EXPANSION.
     */
    bool Decrypt(Span<const unsigned char> cipher, Span<const unsigned char> aad, Nonce96 nonce, Span<unsigned char> plain) noexcept
    {
     ...
     * Requires cipher.size() = plain1.size() + plain2.size() + EXPANSION.
     */
    bool Decrypt(Span<const unsigned char> cipher, Span<const unsigned char> aad, Nonce96 nonce, Span<unsigned char> plain1, Span<unsigned char> plain2) noexcept;
     ...
     */
    void Keystream(Nonce96 nonce, Span<unsigned char> keystream) noexcept;
};
...
public:
    ...
    FSChaCha20Poly1305(Span<const unsigned char> key, uint32_t rekey_interval) noexcept :
     ...
     * Requires cipher.size() = plain.size() + EXPANSION.
     */
    void Encrypt(Span<const unsigned char> plain, Span<const unsigned char> aad, Span<unsigned char> cipher) noexcept
    {
     ...
     * Requires cipher.size() = plain.size() + EXPANSION.
     */
    void Encrypt(Span<const unsigned char> plain1, Span<const unsigned char> plain2, Span<const unsigned char> aad, Span<unsigned char> cipher) noexcept;

    /** Decrypt a message with a specified aad. Returns true if valid.
     *
     * Requires cipher.size() = plain.size() + EXPANSION.
     */
    bool Decrypt(Span<const unsigned char> cipher, Span<const unsigned char> aad, Span<unsigned char> plain) noexcept
    {
     ...
     * Requires cipher.size() = plain1.size() + plain2.size() + EXPANSION.
     */
    bool Decrypt(Span<const unsigned char> cipher, Span<const unsigned char> aad, Span<unsigned char> plain1, Span<unsigned char> plain2) noexcept;
};

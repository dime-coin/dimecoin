...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Dimecoin Core dimecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dimecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dimecoin transaction") + "\n" +
              "  dimecoin-tx [options] -create [commands]   " + _("Create hex-encoded dimecoin transaction") + "\n" +
              "\n";

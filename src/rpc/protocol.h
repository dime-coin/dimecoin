...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in dimecoind
    ...
    RPC_CLIENT_NODE_CAPACITY_REACHED= -34, //!< Max number of added nodes already reached (matches Bitcoin Core)

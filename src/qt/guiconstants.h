...
static const int MODEL_UPDATE_DELAY = 300;
...
#define QAPP_ORG_NAME "Dimecoin"
#define QAPP_ORG_DOMAIN "www.dimecoinnetwork.com"
#define QAPP_APP_NAME_DEFAULT "Dimecoin-Qt"

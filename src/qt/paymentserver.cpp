...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click dimecoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start dimecoin: click-to-pay handler");
    else
...
{
    // clicking on dimecoin: URLs creates FileOpen events on the Mac:

...
<context>
    ...
    <message>
        ...
        <translation>Это ваши Dimecoin адреса для отправки платежа. Всегда проверяйте сумму и адрес получателя перед отправкой платежа.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши Dimecoin адреса для получения платежей. Настоятельно рекомендуем использовать новые адреса для получения каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Подписывайте сообщения Dimecoin адресами чтобы подтвердить что это написали именно Вы</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Dimecoin addresses</source>
        <translation>Проверяйте сообщения чтобы убедиться что они подписаны конкретными Dimecoin адресами</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное подключение к сети Dimecoin</numerusform><numerusform>%n активных подключения к сети Dimecoin</numerusform><numerusform>%n активных подключений к сети Dimecoin</numerusform><numerusform>%n активных подключений к сети Dimecoin</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. Dimecoin больше не может продолжать безопасную работу и будет закрыт.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Введенный адрес "%1" не является действительным адресом Dimecoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Dimecoin-клиента на маршрутизаторе. Работает только если Ваш маршрутизатор поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключится к сети Dimecoin через SOCKS5 прокси.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью Dimecoin после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>'dimecoin://' не верный URI. Используйте 'dimecoin:' вместо этого.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать идентификатор! Это может быть связано с неверным Dimecoin-адресом или неправильными параметрами идентификатора.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть Dimecoin.</translation>
    </message>
    <message>
...
Примечание: Так как комиссия рассчитывается на основе каждого байта, комиссия  "100 сатошей за КБ " для транзакции размером 500 байт (половина 1 КБ) в конечном счете, приведет к сбору только 50 сатошей.</translation>
    ...
    <message>
        ...
        <translation>Оплата только минимальной комиссии - это нормально, если объем транзакций меньше, чем места в блоках. Но имейте в виду, что это может привести к тому, что транзакция никогда не будет подтверждена, если спрос на биткойн-транзакции будет больше, чем может обработать сеть.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Предупреждение: Неверный Dimecoin адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Dimecoin-адрес, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>Сообщение прикрепленное к dimecoin идентификатору будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Dimecoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Dimecoin-адрес, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать предыдущий использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение адресом Dimecoin</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>Dimecoin-адрес, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Dimecoin address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным Dimecoin-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
...
<context>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>созревает еще в %n блоке</numerusform><numerusform>созревает еще в %n кварталах</numerusform><numerusform>созревает еще в %n кварталах</numerusform><numerusform>созревает еще в %n блоках</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Группируйте выходы по адресу, выбирая все или ни одного, вместо того, чтобы выбирать для каждого выхода. Конфиденциальность улучшается, так как адрес используется только один раз (если кто-то не отправляет на него после того, как с него тратят деньги), но может привести к немного более высокой плате, поскольку может возникнуть неоптимальный выбор монет из-за добавленного ограничения (по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка создания %s: вы не можете создавать не HD-кошельки с этой версией.</translation>
    </message>
    <message>
